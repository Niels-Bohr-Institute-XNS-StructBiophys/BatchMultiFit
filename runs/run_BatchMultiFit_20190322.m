(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190322.m" >> run_BatchMultiFit_20190322.log & *)
...
(*
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_OSL_LARGER_005_more/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_3p0BC_1to5dil_OSL_LARGER_005_more/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_OSL_LARGER_005_more/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_OSL_LARGER_005_more/";
Xnmode="X";
...
(* Load XNDiff output data, Y-files for dilute SSS suspension *)
YFileDir="out/";
YFileList=FileNames[YFileDir<>"SSS_180x360_P*_N50_OSL_HUGE.log"];
YFileList=StringTrim[StringTrim[#,YFileDir],".log"]&/@YFileList;



(* with ycohscf(0.5-2.0), T *)
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_OSL_HUGE_005_more/";
Xnmode="X";
expfileconc={"export/im_0051238_caz_CapA_0p0BC_1to5dil-H2O_s-scaled_sIdI.chi",0.05};
Nmaxsp=6;
Nmaxst=0;
...
(* with ycohscf(0.5-2.0), T *)
OutDir="MathematicaOut/SSS_3p0BC_1to5dil_OSL_HUGE_005_more/";
Xnmode="X";
expfileconc={"export/im_0051239_caz_CapB_3p0BC_1to5dil-H2O_s-scaled_sIdI.chi",0.05};
Nmaxsp=6;
Nmaxst=0;
...
(* with ycohscf(0.5-2.0), T *)
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_OSL_HUGE_005_more/";
Xnmode="X";
expfileconc={"export/im_0051247_caz_CapA_5p0BC_1to5dil-H2O_s-scaled_sIdI.chi",0.05};
Nmaxsp=6;
Nmaxst=0;
...
(* with ycohscf(0.5-2.0), T *)
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_OSL_HUGE_005_more/";
Xnmode="X";
expfileconc={"export/im_0051251_caz_CapA_7p5BC_1to5dil-H2O_s-scaled_sIdI.chi",0.05};
Nmaxsp=6;
Nmaxst=0;
