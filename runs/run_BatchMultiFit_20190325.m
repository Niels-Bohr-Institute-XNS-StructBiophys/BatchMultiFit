(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190325.m" >> run_BatchMultiFit_20190325.log & *)
...
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_OSL_SMALLER_005/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_OSL_SMALLER_005/";
Xnmode="X";
