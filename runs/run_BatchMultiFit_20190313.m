(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190313.m" >> run_BatchMultiFit_20190313.log & *)
...
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_OSL_HUGE_005/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_3p0BC_1to5dil_OSL_HUGE_005/";
Xnmode="X";
