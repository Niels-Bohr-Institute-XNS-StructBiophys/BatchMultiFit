(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190326.m" >> run_BatchMultiFit_20190326.log & *)
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_OSL_017/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_OSL_017/";
Xnmode="X";
