(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190323.m" >> run_BatchMultiFit_20190323.log & *)
...
YFileDir="out/";
YFileList=FileNames[YFileDir<>"SSS_180x360_P*_N50_OSL_ASSYM.log"];
...
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_OSL_ASSYM_005/";
Xnmode="X";
...
(* with ycohscf(0.5-2.0), T *)
OutDir="MathematicaOut/SSS_3p0BC_1to5dil_OSL_ASSYM_005/";
Xnmode="X";
...
(* with ycohscf(0.5-2.0), T *)
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_OSL_ASSYM_005/";
Xnmode="X";
...
(* with ycohscf(0.5-2.0), T *)
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_OSL_ASSYM_005/";
Xnmode="X";
