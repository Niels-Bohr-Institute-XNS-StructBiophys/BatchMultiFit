(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190206.m" >> run_BatchMultiFit_20190206.log & *)
...
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_OSL_011/";
Xnmode="X";
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",True,0.2},{"c2",True,0.3},{"c3",True,0.3},{"c4",True,0.1},{"c5",True,0.1},{"c6",True,0.0},{"rhoisl",True,0,"320<#<355"},{"rhoosl",True,0,"320<#<355"},{"rhodm",True,0,"334<#<340"},{"Xa",True,0.002,"0.001<#<0.005"}};
...
OutDir="MathematicaOut/SSS_3p0BC_1to5dil_OSL_011/";
Xnmode="X";
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",True,0.2},{"c2",True,0.3},{"c3",True,0.3},{"c4",True,0.1},{"c5",True,0.1},{"c6",True,0.0},{"rhoisl",True,0,"326<#<330"},{"rhoosl",True,0,"342<#<346"},{"rhodm",True,0,"334<#<340"},{"Xa",True,0.002,"0.001<#<0.005"}};PlRange={{0.002,0.5},{10^-3,10^2}};
plsc=1; (* Default *)
Ymode=1; (* Default *)
AddConstraints={}; (* Default *)
Smear={0,0.0}; (* Default *)
...
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_OSL_011/";
Xnmode="X";
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",True,0.2},{"c2",True,0.3},{"c3",True,0.3},{"c4",True,0.1},{"c5",True,0.1},{"c6",True,0.0},{"rhoisl",True,0,"326<#<330"},{"rhoosl",True,0,"337<#<341"},{"rhodm",True,0,"334<#<340"},{"Xa",True,0.002,"0.001<#<0.005"}};PlRange={{0.002,0.5},{10^-3,10^2}};
plsc=1; (* Default *)
Ymode=1; (* Default *)
AddConstraints={}; (* Default *)
Smear={0,0.0}; (* Default *)
...
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_OSL_011/";
Xnmode="X";
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",True,0.2},{"c2",True,0.3},{"c3",True,0.3},{"c4",True,0.1},{"c5",True,0.1},{"c6",True,0.0},{"rhoisl",True,0,"326<#<330"},{"rhoosl",True,0,"333<#<337"},{"rhodm",True,0,"334<#<340"},{"Xa",True,0.002,"0.001<#<0.005"}};PlRange={{0.002,0.5},{10^-3,10^2}};
plsc=1; (* Default *)
Ymode=1; (* Default *)
AddConstraints={}; (* Default *)
Smear={0,0.0}; (* Default *)
