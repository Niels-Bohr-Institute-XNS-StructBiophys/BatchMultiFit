(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190223.m" >> run_BatchMultiFit_20190223.log & *)
...
(* just noted that stacks with d_st = 23 nm and particles >3 unit cells thickness are physically unrealistic -> new simulations with particles of only 3 unit cells *) 
OutDir="MathematicaOut/SSS_0p0BC_native_OSL_001/";
Xnmode="X";
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",False,0.052586},{"c2",False,0.004511},{"c3",False,0.420543},{"c4",False,0.356191},{"c5",False,0.119113},{"c6",False,0.047056},{"d2",True},{"d3",True},{"d4",True},{"d5",True},{"rhoisl",True,0,"300<#<360"},{"rhoosl",True,0,"300<#<360"},{"rhodm",True,0,"333<#<340"},{"Xa",True,0.02,"0.001<#<0.025"}};
