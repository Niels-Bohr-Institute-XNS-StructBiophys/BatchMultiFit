(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190610_native_STMOD3.m" >> run_BatchMultiFit_20190610_native_STMOD3.log & *)
...
YFileDir="out/";
YFileList=FileNames[YFileDir<>"SSS_180x360_P*_STMOD3_N50_OSL_ASSYM_3p0BC_native.log"];
...
OutDir="MathematicaOut/SSS_3p0BC_native_STMOD3_OSL_011/";
Xnmode="X";
...
OutDir="MathematicaOut/SSS_3p0BC_native_STMOD3_OSL_013/";
Xnmode="X";
expfileconc={"export/im_0051259_caz_CapA_3p0BC_native-H2O_s-scaled_sIdI.chi",0.30};
Nmaxsp=6;
Nmaxst=3;
...
(* Load XNDiff output data, Y-files *)
YFileDir="out/";
YFileList=FileNames[YFileDir<>"SSS_180x360_P*_STMOD3_N50_OSL_ASSYM_5p0BC_native.log"];
YFileList=StringTrim[StringTrim[#,YFileDir],".log"]&/@YFileList;


(* with ycohscf(0.5-2.5), T, w/ start values from OSL_005/ fits, DiffEvol ign. start values for di and chi, use chi/cdConstr with constraint 0.0<chi<0.5 *)

OutDir="MathematicaOut/SSS_5p0BC_native_STMOD3_OSL_011/";
Xnmode="X";
...
OutDir="MathematicaOut/SSS_5p0BC_native_STMOD3_OSL_013/";
Xnmode="X";
expfileconc={"export/im_0051260_caz_CapB_5p0BC_native-H2O_s-scaled_sIdI.chi",0.30};
Nmaxsp=6;
Nmaxst=3;
...
(* Load XNDiff output data, Y-files *)
YFileDir="out/";
YFileList=FileNames[YFileDir<>"SSS_180x360_P*_STMOD3_N50_OSL_ASSYM_7p5BC_native.log"];
YFileList=StringTrim[StringTrim[#,YFileDir],".log"]&/@YFileList;
...
OutDir="MathematicaOut/SSS_7p5BC_native_STMOD3_OSL_011/";
Xnmode="X";
...
OutDir="MathematicaOut/SSS_7p5BC_native_STMOD3_OSL_013/";
Xnmode="X";
expfileconc={"export/im_0051266_caz_CapA_7p5BC_native-H2O_s-scaled_sIdI.chi",0.30};
Nmaxsp=6;
Nmaxst=3;
