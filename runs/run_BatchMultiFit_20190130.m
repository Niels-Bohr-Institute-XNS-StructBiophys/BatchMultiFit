(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190130.m" >> run_BatchMultiFit_20190130.log & *)
...
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_OSL_009/";
Xnmode="X";
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",True,0.2},{"c2",True,0.3},{"c3",True,0.3},{"c4",True,0.1},{"c5",True,0.1},{"c6",True,0.0},{"rhoisl",True,0,"270<#<400"},{"rhoosl",True,0,"270<#<400"},{"rhodm",True,0,"330.7<#<337.3"},{"Xa",True,0.002,"0.001<#<0.005"}};
