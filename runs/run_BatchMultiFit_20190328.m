(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190328.m" >> run_BatchMultiFit_20190328.log & *)
...
YFileDir="out/";
YFileList=FileNames[YFileDir<>"SSS_180x360_P*_ST_360_400_N50_OSL_SMALLER.log"];
YFileList=StringTrim[StringTrim[#,YFileDir],".log"]&/@YFileList;



(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_OSL_SMALLER_005_more/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_3p0BC_1to5dil_OSL_SMALLER_005_more/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_OSL_SMALLER_005_more/";
Xnmode="X";
...
(* with ycohscf(0.5-2.5), T *)
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_OSL_SMALLER_005_more/";
Xnmode="X";
