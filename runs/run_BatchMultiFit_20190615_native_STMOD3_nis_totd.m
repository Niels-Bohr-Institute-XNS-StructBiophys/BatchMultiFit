(* screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFit_20190615_native_STMOD3_nis_totd.m" >> run_BatchMultiFit_20190615_native_STMOD3_nis_totd.log & *)
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",False,0.0569721703},{"c2",False,0.0064034703},{"c3",False,0.4180488201},{"c4",False,0.3559066429},{"c5",False,0.1183186870},{"c6",False,0.0443502094},{"d2",True,0.25},{"d3",True,0.25},{"d4",True,0.25},{"d5",True,0.25},{"rhoisl",True,325,"300<#<360"},{"rhoosl",True,350,"300<#<360"},{"rhodm",True,335,"333<#<345"},{"Xa",True,0.02,"0.001<#<0.025"}};
...
(* same as 011/ but with 0<chi<0.7 i.e. max 70% sp and min 30% stacks, and max 3er stacks *)

OutDir="MathematicaOut/SSS_0p0BC_native_STMOD3_nis_totd_OSL_013/";
Xnmode="X";
expfileconc={"export/im_0051252_caz_CapB_0p0BC_native-H2O_s-scaled_sIdI.chi",0.30};
Nmaxsp=6;
Nmaxst=3;
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",False,0.0569721703},{"c2",False,0.0064034703},{"c3",False,0.4180488201},{"c4",False,0.3559066429},{"c5",False,0.1183186870},{"c6",False,0.0443502094},{"d2",True,0.5},{"d3",True,0.5},{"rhoisl",True,325,"300<#<360"},{"rhoosl",True,350,"300<#<360"},{"rhodm",True,335,"333<#<340"},{"Xa",True,0.02,"0.001<#<0.025"}};
PlRange={{0.002,0.5},{10^-2,10^2}};
plsc=1; (* Default *)
Ymode=1; (* Default, only 1 type of Yfiles *)
AddConstraints={}; (* Default *)
...
OutDir="MathematicaOut/SSS_3p0BC_native_STMOD3_nis_totd_OSL_011/";
Xnmode="X";
...
FitMaxIt=1000;
FitTarF=T;
ParStart={{"c1",False,0.26249759281607415},{"c2",False,0.09872287568105395},{"c3",False,0.36419901965372614},{"c4",False,0.16257579386053717},{"c5",False,0.0817375025739596},{"c6",False,0.03026721541464894},{"d2",True,0.25},{"d3",True,0.25},{"d4",True,0.25},{"d5",True,0.25},{"rhoisl",True,325,"300<#<360"},{"rhoosl",True,350,"300<#<360"},{"rhodm",True,335,"333<#<345"},{"Xa",True,0.02,"0.001<#<0.025"}};
PlRange={{0.002,0.5},{10^-2,10^2}};
plsc=1; (* Default *)
Ymode=1; (* Default, only 1 type of Yfiles *)
AddConstraints={}; (* Default *)
...
OutDir="MathematicaOut/SSS_3p0BC_native_STMOD3_nis_totd_OSL_013/";
Xnmode="X";
expfileconc={"export/im_0051259_caz_CapA_3p0BC_native-H2O_s-scaled_sIdI.chi",0.30};
Nmaxsp=6;
Nmaxst=3;
...
OutDir="MathematicaOut/SSS_5p0BC_native_STMOD3_nis_totd_OSL_011/";
Xnmode="X";
...
OutDir="MathematicaOut/SSS_5p0BC_native_STMOD3_nis_totd_OSL_013/";
Xnmode="X";
expfileconc={"export/im_0051260_caz_CapB_5p0BC_native-H2O_s-scaled_sIdI.chi",0.30};
Nmaxsp=6;
Nmaxst=3;
...
OutDir="MathematicaOut/SSS_7p5BC_native_STMOD3_nis_totd_OSL_011/";
Xnmode="X";
...
OutDir="MathematicaOut/SSS_7p5BC_native_STMOD3_nis_totd_OSL_013/";
Xnmode="X";
expfileconc={"export/im_0051266_caz_CapA_7p5BC_native-H2O_s-scaled_sIdI.chi",0.30};
Nmaxsp=6;
Nmaxst=3;
