...
MathKernel -noprompt -run "<<run_BatchMultiFitStat_20190121_1to5dil_003-4.m" > run_BatchMultiFitStat_20190121_1to5dil_003-4.log &

on a (headless) server (where no X is running):
screen -d -m xvfb-run MathKernel -noprompt -run "<<run_BatchMultiFitStat_20190121_1to5dil_003-4.m" > run_BatchMultiFitStat_20190121_1to5dil_003-4.log
