(* nice MathKernel -noprompt -run "<<run_BatchMultiFit.m" >> run_BatchMultiFit_20190120.log & *)
...
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_006/";
Xnmode="X";
...
(* with ycohscf, T *)
OutDir="MathematicaOut/SSS_0p0BC_1to5dil_005/";
Xnmode="X";
expfileconc={"export/im_0051238_caz_CapA_0p0BC_1to5dil-H2O_s-scaled_sIdI.chi",0.0317};
Nmaxsp=6;
Nmaxst=0;
