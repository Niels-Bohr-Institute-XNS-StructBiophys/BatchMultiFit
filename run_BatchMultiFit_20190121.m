(* nice MathKernel -noprompt -run "<<run_BatchMultiFit.m" >> run_BatchMultiFit_20190121.log & *)
...
(* with ycohscf, T *)
OutDir="MathematicaOut/SSS_3p0BC_1to5dil_005/";
Xnmode="X";
...
(* with ycohscf, T *)
OutDir="MathematicaOut/SSS_5p0BC_1to5dil_005/";
Xnmode="X";
...
(* with ycohscf, T *)
OutDir="MathematicaOut/SSS_7p5BC_1to5dil_005/";
Xnmode="X";
